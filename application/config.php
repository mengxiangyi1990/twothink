...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '&",BQP4;/cJ6^kRrazltG8*~gLD(SKb.w5|f!?CE', //默认数据加密KEY
	'data_cache_key'=> '&",BQP4;/cJ6^kRrazltG8*~gLD(SKb.w5|f!?CE',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'&",BQP4;/cJ6^kRrazltG8*~gLD(SKb.w5|f!?CE', //加密KEY
